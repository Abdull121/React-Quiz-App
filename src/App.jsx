...
function App() {
  ...
  const option = quizData[questionCount].answers.map((option, index) => {
    return (
      <button
        className="flex m-5 p-5 w-80 text-center justify-center border-4 border-sky-800 rounded-lg hover:bg-blue-300 focus:outline-none  focus:bg-green-500"
        key={index}
    ...
    <>
      <div className="flex text-center justify-center mt-4 flex-col px-3 mx-1">
        ...
        <div className="my-5 flex justify-center flex-col items-center">
          ...
          <input
            className="my-5 px-10 py-3 cursor-pointer
